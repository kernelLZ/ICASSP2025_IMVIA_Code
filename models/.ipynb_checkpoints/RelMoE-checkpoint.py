...
class RelMoE(BaseModel):
    ...
    def forward(self, batch_inputs):
        ...
        if not self.training:
            return [pred_s, pred_i, pred_d, pred_mm], [atten_s, atten_i, atten_t, attn_f], [e_embed, e_img_embed, e_txt_embed]
        else:
            return [pred_s, pred_i, pred_d, pred_mm], [disen_str, disen_img, disen_txt], [e_embed, e_img_embed, e_txt_embed]
    ...
    def loss_func(self, output, target, e_embed):
        ...
        return loss_s + loss_i + loss_d + loss_mm + loss_struct_img + loss_struct_txt + loss_img_txt
