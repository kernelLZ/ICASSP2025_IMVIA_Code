...
class MIEstimator(nn.Module):
    ...
    def forward(self, embeddings):
        ...
        # mi_loss = ( self.str_estimator(str1, str2) + self.txt_estimator(txt1, txt2)) / 2.0
    ...
    def train_estimator(self, embeddings):
        ...
        # est_loss = (self.img_estimator.learning_loss(img1, img2) + self.txt_estimator.learning_loss(txt1, txt2)) / 2.0
